...
If your trace infomation requires pre-processing, then you can override the Sampler's 'process_trace() method, while by default will just return the trace object unmodified. 
eg.
----
